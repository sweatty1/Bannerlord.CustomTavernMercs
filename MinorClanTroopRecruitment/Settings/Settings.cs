...
namespace MinorClanTroopRecruitment.Settings
{
    class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        public DefaultDropdown<string> RecruitmentSettings { get; set; } = new DefaultDropdown<string>(new string[] { "Any Culture", "Same Culture Only", "Custom" }, 0); // "Regional", "Custom" future option ids for xml inputs
